...
import com.epicode.repository.MenuDAORepository;
import com.epicode.repository.TavoloDAORepository;

@Service
public class MenuService {
	
	@Autowired MenuDAORepository repo;
	@Autowired TavoloDAORepository repo2;
...
//	}
	...
	public void saveOrdine(Ordine o) {
		repo.save(o);
		log.info("L'ordine numero: " + o.getNumeroOrdine() + " è stato salvato nel DB!!!");
	}
	
	public void saveTavolo(Tavolo t) {
		repo2.save(t);
		log.info("Il tavolo numero:" + t.getNumero() + " è stato salvato nel DB!!!");
	}
	
	public Tavolo findTavolo(long id) {
